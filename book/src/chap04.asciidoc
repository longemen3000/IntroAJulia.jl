...
(((using)))((("palabra reservada", "using", véase "using")))(((sentencia using)))((("sentencia", "using", véase "sentencia using")))
...
(((turn)))((("function", "IntroAJulia", "turn", véase "turn")))
...
(((sentencia for)))((("sentencia", "for", véase "sentencia for")))(((for)))((("palabra reservada", "for", véase "for")))(((in)))((("palabra reservada", "in", véase "in")))
...
(((polyline)))((("function", "definida por el programador", "polyline", véase "polyline")))
