...
El ((("$$/$$ (operador de división)", véase "* division")))((("division", "operador de división ($$/$$)")))operador +/+ realiza la división:
...
¿Qué ((("comillas (&quot;&#x2026;&quot;)", "enclosing strings"))) ((("&quot;&#x2026;&quot; (comillas)", "enclosing strings", véase "* comillas")))pasa con los valores +"2"+ y +"42.0"+? Parecen números, pero están entre comillas como si fueran cadenas. Estos valores también son cadenas:
...
Sin embargo, puede ((("guión bajo (_)", "en enteros"))) ((("_ (guión bajo)", "en enteros", véase "* guión bajo"))) obtener el resultado esperado usando +1_000_000+.
